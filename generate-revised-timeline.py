...
# Revised song data with descriptions
songs = [
    {
        'year': '1948',
    ...
    },
    {
        ...
        'track': 'Symphonie pour un Homme Seul',
        'era': 'MUSIQUE CONCRÈTE & EARLY ELECTRONICS',
        'description': 'First major concrète composition.'
    },
    {
        'year': '1952',
        'artist': 'John Cage',
    ...
    },
    {
        ...
        'track': 'Kontakte',
        'era': 'MUSIQUE CONCRÈTE & EARLY ELECTRONICS',
        'description': 'Landmark spatialized electronic composition.'
    },
    {
        'year': '1960',
        'artist': 'Daphne Oram',
    ...
    },
    {
        ...
        'description': 'Birth of minimalism.'
    },
    {
        'year': '1965',
        'artist': 'Steve Reich',
    ...
    },
    {
        ...
        'track': 'Piano Phase',
        'era': 'MINIMALISM / PROCESS MUSIC',
        'description': 'Defines process minimalism.'
    },
    {
        'year': '1974',
        'artist': 'Kraftwerk',
    ...
    },
    {
        ...
        'era': 'ELECTRONIC PIONEERS / AMBIENT',
        'description': 'Beginning of ambient as a compositional concept.'
    },
    {
        'year': '1978',
        'artist': 'Brian Eno',
    ...
    },
    {
        ...
        'description': 'Prototype techno structure.'
    },
    {
        'year': '1986',
    ...
    },
    {
        ...
        'era': 'IDM / ELECTRONICA',
        'description': 'Foundation of ambient techno + IDM.'
    },
    {
        'year': '1995',
        'artist': 'Autechre',
        'track': 'Tri Repetae',
        'era': 'IDM / ELECTRONICA',
        'description': 'Defines algorithmic, abstract IDM.'
    },
    {
        'year': '1998',
    ...
    },
    {
        ...
        'description': 'Minimalist digital/glitch blueprint.'
    },
    {
        'year': '2005',
        'artist': 'Ryoji Ikeda',
    ...
    },
    {
        ...
        'track': 'Returnal',
        'era': 'GLITCH / CONTEMPORARY EXPERIMENTAL',
        'description': 'Overrated or not, still widely regarded as a turning point in modern experimental electronic music.'
    }
]
...
# Now generate the new index.html
...
for era_name in [
    ...
    if era_name in eras:
        ...
        for song in eras[era_name]:
            filename = generate_filename(song['artist'], song['track'], song['year'])
            timeline_html += f'''
        <a href="songs/{filename}" class="timeline-item">
            <div class="year">{song['year']}</div>
            <div class="artist">{song['artist']}</div>
            <div class="track">{song['track']}</div>
            <div class="description">{song['description']}</div>
    ...
    <script>
        ...
        items.forEach(item => {{
            item.addEventListener('mouseenter', function() {{
                ...
                // You can replace this with actual track URLs later
...
print("New index.html generated!")
print("\n✓ Timeline restructuring complete!")
